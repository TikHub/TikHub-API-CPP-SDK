...
void LikeRequest::validate()
{
    // TODO: implement validation
}

web::json::value LikeRequest::toJson() const
{
...
bool LikeRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LikeRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LikeRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t LikeRequest::getAwemeId() const
{
    return m_Aweme_id;
}

void LikeRequest::setAwemeId(const utility::string_t& value)
{
    m_Aweme_id = value;
    m_Aweme_idIsSet = true;
}

bool LikeRequest::awemeIdIsSet() const
{
    return m_Aweme_idIsSet;
}

void LikeRequest::unsetAweme_id()
{
    m_Aweme_idIsSet = false;
}
utility::string_t LikeRequest::getCookie() const
{
    return m_Cookie;
}

void LikeRequest::setCookie(const utility::string_t& value)
{
    m_Cookie = value;
    m_CookieIsSet = true;
}

bool LikeRequest::cookieIsSet() const
{
    return m_CookieIsSet;
}

void LikeRequest::unsetCookie()
{
    m_CookieIsSet = false;
}
utility::string_t LikeRequest::getDeviceId() const
{
    return m_Device_id;
}

void LikeRequest::setDeviceId(const utility::string_t& value)
{
    m_Device_id = value;
    m_Device_idIsSet = true;
}

bool LikeRequest::deviceIdIsSet() const
{
    return m_Device_idIsSet;
}

void LikeRequest::unsetDevice_id()
{
    m_Device_idIsSet = false;
}
utility::string_t LikeRequest::getIid() const
{
    return m_Iid;
}

void LikeRequest::setIid(const utility::string_t& value)
{
    m_Iid = value;
    m_IidIsSet = true;
}

bool LikeRequest::iidIsSet() const
{
    return m_IidIsSet;
}

void LikeRequest::unsetIid()
{
    m_IidIsSet = false;
}
utility::string_t LikeRequest::getProxy() const
{
    return m_Proxy;
}

void LikeRequest::setProxy(const utility::string_t& value)
{
    m_Proxy = value;
    m_ProxyIsSet = true;
}

bool LikeRequest::proxyIsSet() const
{
    return m_ProxyIsSet;
}

void LikeRequest::unsetProxy()
{
    m_ProxyIsSet = false;
}
}
