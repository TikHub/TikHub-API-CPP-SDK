...
void CollectRequest::validate()
{
    // TODO: implement validation
}

web::json::value CollectRequest::toJson() const
{
...
bool CollectRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CollectRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CollectRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t CollectRequest::getAwemeId() const
{
    return m_Aweme_id;
}

void CollectRequest::setAwemeId(const utility::string_t& value)
{
    m_Aweme_id = value;
    m_Aweme_idIsSet = true;
}

bool CollectRequest::awemeIdIsSet() const
{
    return m_Aweme_idIsSet;
}

void CollectRequest::unsetAweme_id()
{
    m_Aweme_idIsSet = false;
}
utility::string_t CollectRequest::getCookie() const
{
    return m_Cookie;
}

void CollectRequest::setCookie(const utility::string_t& value)
{
    m_Cookie = value;
    m_CookieIsSet = true;
}

bool CollectRequest::cookieIsSet() const
{
    return m_CookieIsSet;
}

void CollectRequest::unsetCookie()
{
    m_CookieIsSet = false;
}
utility::string_t CollectRequest::getDeviceId() const
{
    return m_Device_id;
}

void CollectRequest::setDeviceId(const utility::string_t& value)
{
    m_Device_id = value;
    m_Device_idIsSet = true;
}

bool CollectRequest::deviceIdIsSet() const
{
    return m_Device_idIsSet;
}

void CollectRequest::unsetDevice_id()
{
    m_Device_idIsSet = false;
}
utility::string_t CollectRequest::getIid() const
{
    return m_Iid;
}

void CollectRequest::setIid(const utility::string_t& value)
{
    m_Iid = value;
    m_IidIsSet = true;
}

bool CollectRequest::iidIsSet() const
{
    return m_IidIsSet;
}

void CollectRequest::unsetIid()
{
    m_IidIsSet = false;
}
utility::string_t CollectRequest::getProxy() const
{
    return m_Proxy;
}

void CollectRequest::setProxy(const utility::string_t& value)
{
    m_Proxy = value;
    m_ProxyIsSet = true;
}

bool CollectRequest::proxyIsSet() const
{
    return m_ProxyIsSet;
}

void CollectRequest::unsetProxy()
{
    m_ProxyIsSet = false;
}
}
