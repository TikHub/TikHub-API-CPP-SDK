...
/*
 * ReplyCommentRequest.h
 *
 * ReplyCommentRequest
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ReplyCommentRequest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ReplyCommentRequest_H_
...
public:
    ...
    /// </summary>
    utility::string_t getReplyId() const;
    bool replyIdIsSet() const;
    void unsetReply_id();

    void setReplyId(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_Reply_id;
    bool m_Reply_idIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ReplyCommentRequest_H_ */
