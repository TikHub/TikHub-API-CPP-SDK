...
BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost()
{
    m_Page_num = 0;
...
void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::validate()
{
    // TODO: implement validation
}

web::json::value BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::toJson() const
{
...
bool BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::getPageNum() const
{
    return m_Page_num;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::setPageNum(int32_t value)
{
    m_Page_num = value;
    m_Page_numIsSet = true;
}

bool BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::pageNumIsSet() const
{
    return m_Page_numIsSet;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::unsetPage_num()
{
    m_Page_numIsSet = false;
}
int32_t BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::getPageSize() const
{
    return m_Page_size;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::setPageSize(int32_t value)
{
    m_Page_size = value;
    m_Page_sizeIsSet = true;
}

bool BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::pageSizeIsSet() const
{
    return m_Page_sizeIsSet;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::unsetPage_size()
{
    m_Page_sizeIsSet = false;
}
int32_t BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::getDateWindow() const
{
    return m_Date_window;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::setDateWindow(int32_t value)
{
    m_Date_window = value;
    m_Date_windowIsSet = true;
}

bool BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::dateWindowIsSet() const
{
    return m_Date_windowIsSet;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::unsetDate_window()
{
    m_Date_windowIsSet = false;
}
utility::string_t BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::getKeyword() const
{
    return m_Keyword;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::setKeyword(const utility::string_t& value)
{
    m_Keyword = value;
    m_KeywordIsSet = true;
}

bool BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::keywordIsSet() const
{
    return m_KeywordIsSet;
}

void BodyFetchHotTotalHotWordListApiV1DouyinBillboardFetchHotTotalHotWordListPost::unsetKeyword()
{
    m_KeywordIsSet = false;
}
}
