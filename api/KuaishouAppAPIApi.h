...
#ifndef IO_TIKHUB_CLIENT_API_KuaishouAppAPIApi_H_
#define IO_TIKHUB_CLIENT_API_KuaishouAppAPIApi_H_
...
public:
    ...
    explicit KuaishouAppAPIApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~KuaishouAppAPIApi();
    ...
    /// </remarks>
    /// <param name="subTabId"> (optional, default to 0)</param>
    /// <param name="subTabName"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchBrandTopListApiV1KuaishouAppFetchBrandTopListGet(
        boost::optional<int32_t> subTabId,
        boost::optional<utility::string_t> subTabName
    ) const;
    /// <summary>
    /// 快手品牌榜单/Kuaishou brand top list
    /// </summary>
    ...
    /// <param name="subTabId"> (optional, default to 0)</param>
    /// <param name="subTabName"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchBrandTopListApiV1KuaishouAppFetchBrandTopListGet_0(
        boost::optional<int32_t> subTabId,
        boost::optional<utility::string_t> subTabName
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBoardCategoriesApiV1KuaishouAppFetchHotBoardCategoriesGet(
    ) const;
    /// <summary>
    /// 快手热榜分类/Kuaishou hot categories
    /// </summary>
    ...
    /// # [中文] ### 用途: - 快手热榜分类 ### 返回: - 分类数据  # [English] ### Purpose: - Kuaishou hot categories ### Returns: - Categories data
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBoardCategoriesApiV1KuaishouAppFetchHotBoardCategoriesGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="boardType"> (optional, default to 0)</param>
    /// <param name="boardId"> (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBoardDetailApiV1KuaishouAppFetchHotBoardDetailGet(
        boost::optional<int32_t> boardType,
        boost::optional<int32_t> boardId
    ) const;
    /// <summary>
    /// 快手热榜详情/Kuaishou hot board detail
    /// </summary>
    ...
    /// <param name="boardType"> (optional, default to 0)</param>
    /// <param name="boardId"> (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBoardDetailApiV1KuaishouAppFetchHotBoardDetailGet_0(
        boost::optional<int32_t> boardType,
        boost::optional<int32_t> boardId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchPersonApiV1KuaishouAppFetchHotSearchPersonGet(
    ) const;
    /// <summary>
    /// 快手热搜人物榜单/Kuaishou hot search person board
    /// </summary>
    ...
    /// # [中文] ### 用途: - 快手热搜人物榜单 ### 返回: - 榜单数据  # [English] ### Purpose: - Kuaishou hot search person board ### Returns: - Board data
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchPersonApiV1KuaishouAppFetchHotSearchPersonGet_0(
    ) const;
    /// <summary>
    ...
    /// <param name="subTabId"> (optional, default to 0)</param>
    /// <param name="subTabName"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveTopListApiV1KuaishouAppFetchLiveTopListGet(
        boost::optional<int32_t> subTabId,
        boost::optional<utility::string_t> subTabName
    ) const;
    /// <summary>
    ...
    /// <param name="subTabId"> (optional, default to 0)</param>
    /// <param name="subTabName"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveTopListApiV1KuaishouAppFetchLiveTopListGet_0(
        boost::optional<int32_t> subTabId,
        boost::optional<utility::string_t> subTabName
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneUserV2ApiV1KuaishouAppFetchOneUserV2Get(
    ...
    /// </remarks>
    /// <param name="userId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneUserV2ApiV1KuaishouAppFetchOneUserV2Get_0(
        utility::string_t userId
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoByShareTextApiV1KuaishouAppFetchOneVideoByUrlGet(
    ...
    /// </remarks>
    /// <param name="shareText"></param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoByShareTextApiV1KuaishouAppFetchOneVideoByUrlGet_0(
        utility::string_t shareText
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoV1ApiV1KuaishouAppFetchOneVideoGet(
    ...
    /// </remarks>
    /// <param name="photoId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoV1ApiV1KuaishouAppFetchOneVideoGet_0(
        utility::string_t photoId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="photoId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoV2ApiV1KuaishouAppFetchOneVideoV2Get(
        utility::string_t photoId
    ) const;
    /// <summary>
    /// 快手单一视频查询接口V2/Kuaishou single video query API V2
    ...
    /// </remarks>
    /// <param name="photoId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoV2ApiV1KuaishouAppFetchOneVideoV2Get_0(
        utility::string_t photoId
    ) const;
    /// <summary>
    ...
    /// <param name="subTabId"> (optional, default to 0)</param>
    /// <param name="subTabName"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchShoppingTopListApiV1KuaishouAppFetchShoppingTopListGet(
        boost::optional<int32_t> subTabId,
        boost::optional<utility::string_t> subTabName
    ) const;
    /// <summary>
    ...
    /// <param name="subTabId"> (optional, default to 0)</param>
    /// <param name="subTabName"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchShoppingTopListApiV1KuaishouAppFetchShoppingTopListGet_0(
        boost::optional<int32_t> subTabId,
        boost::optional<utility::string_t> subTabName
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="userId"></param>
    /// <param name="pcursor"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserHotPostApiV1KuaishouAppFetchUserHotPostGet(
        utility::string_t userId,
        boost::optional<utility::string_t> pcursor
    ) const;
    /// <summary>
    /// 获取用户热门作品数据/Get user hot post data
    /// </summary>
    ...
    /// <param name="userId"></param>
    /// <param name="pcursor"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserHotPostApiV1KuaishouAppFetchUserHotPostGet_0(
        utility::string_t userId,
        boost::optional<utility::string_t> pcursor
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="userId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveInfoApiV1KuaishouAppFetchUserLiveInfoGet(
        utility::string_t userId
    ) const;
    /// <summary>
    /// 获取用户直播信息/Get user live info
    ...
    /// </remarks>
    /// <param name="userId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveInfoApiV1KuaishouAppFetchUserLiveInfoGet_0(
        utility::string_t userId
    ) const;
    /// <summary>
    ...
    /// <param name="userId"></param>
    /// <param name="pcursor"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserPostV2ApiV1KuaishouAppFetchUserPostV2Get(
        utility::string_t userId,
        boost::optional<utility::string_t> pcursor
    ) const;
    /// <summary>
    ...
    /// <param name="userId"></param>
    /// <param name="pcursor"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserPostV2ApiV1KuaishouAppFetchUserPostV2Get_0(
        utility::string_t userId,
        boost::optional<utility::string_t> pcursor
    ) const;
    /// <summary>
    ...
    /// <param name="photoId"></param>
    /// <param name="pcursor"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentApiV1KuaishouAppFetchOneVideoCommentGet(
        utility::string_t photoId,
        boost::optional<utility::string_t> pcursor
    ) const;
    /// <summary>
    ...
    /// <param name="photoId"></param>
    /// <param name="pcursor"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentApiV1KuaishouAppFetchOneVideoCommentGet_0(
        utility::string_t photoId,
        boost::optional<utility::string_t> pcursor
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="shareObjectId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> generateKuaishouShareLinkApiV1KuaishouAppGenerateKuaishouShareLinkGet(
        utility::string_t shareObjectId
    ) const;
    /// <summary>
    /// 生成快手分享链接/Generate Kuaishou share link
    /// </summary>
    ...
    /// </remarks>
    /// <param name="shareObjectId"></param>
    pplx::task<std::shared_ptr<ResponseModel>> generateKuaishouShareLinkApiV1KuaishouAppGenerateKuaishouShareLinkGet_0(
        utility::string_t shareObjectId
    ) const;
    /// <summary>
    ...
    /// <param name="page"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> searchUserV2ApiV1KuaishouAppSearchUserV2Get(
    ...
    /// <param name="keyword"></param>
    /// <param name="page"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> searchUserV2ApiV1KuaishouAppSearchUserV2Get_0(
        utility::string_t keyword,
        boost::optional<utility::string_t> page
    ) const;
    /// <summary>
    ...
    /// <param name="keyword"></param>
    /// <param name="page"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> searchVideoV2ApiV1KuaishouAppSearchVideoV2Get(
        utility::string_t keyword,
        boost::optional<utility::string_t> page
    ) const;
    /// <summary>
    ...
    /// <param name="keyword"></param>
    /// <param name="page"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> searchVideoV2ApiV1KuaishouAppSearchVideoV2Get_0(
        utility::string_t keyword,
        boost::optional<utility::string_t> page
    ) const;
...
#endif /* IO_TIKHUB_CLIENT_API_KuaishouAppAPIApi_H_ */
