...
#ifndef IO_TIKHUB_CLIENT_API_DouyinAppV2APIApi_H_
#define IO_TIKHUB_CLIENT_API_DouyinAppV2APIApi_H_
...
public:
    ...
    explicit DouyinAppV2APIApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~DouyinAppV2APIApi();
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchGeneralSearchResultApiV1DouyinAppV2FetchGeneralSearchResultGet(
    ...
    /// <param name="sortType">排序类型/Sort type (optional, default to 0)</param>
    /// <param name="publishTime">发布时间/Publish time (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchGeneralSearchResultApiV1DouyinAppV2FetchGeneralSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<int32_t> sortType,
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchHashtagDetailApiV1DouyinAppV2FetchHashtagDetailGet(
        int32_t chId
    ) const;
    /// <summary>
    /// 获取指定话题的详情数据/Get details of specified hashtag
    ...
    /// </remarks>
    /// <param name="chId">话题id/Hashtag id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHashtagDetailApiV1DouyinAppV2FetchHashtagDetailGet_0(
        int32_t chId
    ) const;
    /// <summary>
    ...
    /// <param name="offset">偏移量/Offset (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHashtagSearchResultApiV1DouyinAppV2FetchHashtagSearchResultGet(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="offset">偏移量/Offset (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHashtagSearchResultApiV1DouyinAppV2FetchHashtagSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="sortType">排序类型/Sort type (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHashtagVideoListApiV1DouyinAppV2FetchHashtagVideoListGet(
        int32_t chId,
    ...
    /// <param name="sortType">排序类型/Sort type (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHashtagVideoListApiV1DouyinAppV2FetchHashtagVideoListGet_0(
        int32_t chId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> sortType,
        boost::optional<int32_t> count
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBrandSearchApiV1DouyinAppV2FetchBrandHotSearchListDetailGet(
        int32_t categoryId
    ) const;
    /// <summary>
    /// 获取抖音品牌热榜具体分类数据/Get Douyin brand hot search list detail data
    ...
    /// </remarks>
    /// <param name="categoryId">分类id/Category id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBrandSearchApiV1DouyinAppV2FetchBrandHotSearchListDetailGet_0(
        int32_t categoryId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBrandSearchCategoryApiV1DouyinAppV2FetchBrandHotSearchListGet(
    ) const;
    /// <summary>
    /// 获取抖音品牌热榜分类数据/Get Douyin brand hot search list data
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取抖音品牌热榜分类数据 ### 返回: - 品牌热搜榜分类数据  # [English] ### Purpose: - Get Douyin brand hot search category data ### Return: - Hot brand search category data  # [示例/Example] pass
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotBrandSearchCategoryApiV1DouyinAppV2FetchBrandHotSearchListGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchListApiV1DouyinAppV2FetchHotSearchListGet(
    ) const;
    /// <summary>
    /// 获取抖音热搜榜数据/Get Douyin hot search list data
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取抖音热搜榜数据 ### 返回: - 热搜榜数据  # [English] ### Purpose: - Get Douyin hot search list data ### Return: - Hot search list data  # [示例/Example] pass
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchListApiV1DouyinAppV2FetchHotSearchListGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveHotSearchListApiV1DouyinAppV2FetchLiveHotSearchListGet(
    ) const;
    /// <summary>
    /// 获取抖音直播热搜榜数据/Get Douyin live hot search list data
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取抖音直播热搜榜数据 ### 返回: - 直播热搜榜数据  # [English] ### Purpose: - Get Douyin live hot search list data ### Return: - Live hot search list data  # [示例/Example] pass
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveHotSearchListApiV1DouyinAppV2FetchLiveHotSearchListGet_0(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicDetailApiV1DouyinAppV2FetchMusicDetailGet(
    ...
    /// </remarks>
    /// <param name="musicId">音乐id/Music id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicDetailApiV1DouyinAppV2FetchMusicDetailGet_0(
        utility::string_t musicId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicHotSearchListApiV1DouyinAppV2FetchMusicHotSearchListGet(
    ) const;
    /// <summary>
    /// 获取抖音音乐热榜数据/Get Douyin music hot search list data
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取抖音音乐热榜数据 ### 返回: - 音乐热搜榜数据  # [English] ### Purpose: - Get Douyin music hot search list data ### Return: - Music hot search list data  # [示例/Example] pass
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicHotSearchListApiV1DouyinAppV2FetchMusicHotSearchListGet_0(
    ) const;
    /// <summary>
    ...
    /// <param name="offset">偏移量/Offset (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicSearchResultApiV1DouyinAppV2FetchMusicSearchResultGet(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="offset">偏移量/Offset (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicSearchResultApiV1DouyinAppV2FetchMusicSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicVideoListApiV1DouyinAppV2FetchMusicVideoListGet(
        utility::string_t musicId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMusicVideoListApiV1DouyinAppV2FetchMusicVideoListGet_0(
        utility::string_t musicId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoApiV1DouyinAppV2FetchOneVideoGet(
    ...
    /// </remarks>
    /// <param name="awemeId">作品id/Video id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoApiV1DouyinAppV2FetchOneVideoGet_0(
        utility::string_t awemeId
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoByShareUrlApiV1DouyinAppV2FetchOneVideoByShareUrlGet(
    ...
    /// </remarks>
    /// <param name="shareUrl">分享链接/Share link</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoByShareUrlApiV1DouyinAppV2FetchOneVideoByShareUrlGet_0(
        utility::string_t shareUrl
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLikeVideosApiV1DouyinAppV2FetchUserLikeVideosGet(
    ...
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLikeVideosApiV1DouyinAppV2FetchUserLikeVideosGet_0(
        utility::string_t secUserId,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> counts
    ) const;
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserPostVideosApiV1DouyinAppV2FetchUserPostVideosGet(
        utility::string_t secUserId,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="count">每页数量/Number per page (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserPostVideosApiV1DouyinAppV2FetchUserPostVideosGet_0(
        utility::string_t secUserId,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="offset">偏移量/Offset (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultApiV1DouyinAppV2FetchUserSearchResultGet(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="offset">偏移量/Offset (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultApiV1DouyinAppV2FetchUserSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsApiV1DouyinAppV2FetchVideoCommentsGet(
        utility::string_t awemeId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsApiV1DouyinAppV2FetchVideoCommentsGet_0(
        utility::string_t awemeId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsReplyApiV1DouyinAppV2FetchVideoCommentRepliesGet(
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsReplyApiV1DouyinAppV2FetchVideoCommentRepliesGet_0(
        utility::string_t itemId,
        utility::string_t commentId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoMixDetailApiV1DouyinAppV2FetchVideoMixDetailGet(
    ...
    /// </remarks>
    /// <param name="mixId">合集id/Mix id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoMixDetailApiV1DouyinAppV2FetchVideoMixDetailGet_0(
        utility::string_t mixId
    ) const;
    /// <summary>
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoMixPostListApiV1DouyinAppV2FetchVideoMixPostListGet(
        utility::string_t mixId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoMixPostListApiV1DouyinAppV2FetchVideoMixPostListGet_0(
        utility::string_t mixId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="sortType">排序类型/Sort type (optional, default to 0)</param>
    /// <param name="publishTime">发布时间/Publish time (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoSearchResultApiV1DouyinAppV2FetchVideoSearchResultGet(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<int32_t> sortType,
    ...
    /// <param name="sortType">排序类型/Sort type (optional, default to 0)</param>
    /// <param name="publishTime">发布时间/Publish time (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoSearchResultApiV1DouyinAppV2FetchVideoSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<int32_t> sortType,
    ...
    pplx::task<std::shared_ptr<ResponseModel>> generateDouyinShortUrlApiV1DouyinAppV2GenerateDouyinShortUrlGet(
    ...
    /// </remarks>
    /// <param name="url">抖音链接/Douyin link</param>
    pplx::task<std::shared_ptr<ResponseModel>> generateDouyinShortUrlApiV1DouyinAppV2GenerateDouyinShortUrlGet_0(
        utility::string_t url
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> generateDouyinVideoShareQrcodeApiV1DouyinAppV2GenerateDouyinVideoShareQrcodeGet(
    ...
    /// </remarks>
    /// <param name="objectId">作品id/Video id</param>
    pplx::task<std::shared_ptr<ResponseModel>> generateDouyinVideoShareQrcodeApiV1DouyinAppV2GenerateDouyinVideoShareQrcodeGet_0(
        utility::string_t objectId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="secUserId">用户sec_user_id/User sec_user_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileApiV1DouyinAppV2HandlerUserProfileGet(
        utility::string_t secUserId
    ) const;
    /// <summary>
    /// 获取指定用户的信息/Get information of specified user
    ...
    /// </remarks>
    /// <param name="secUserId">用户sec_user_id/User sec_user_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileApiV1DouyinAppV2HandlerUserProfileGet_0(
        utility::string_t secUserId
    ) const;
...
#endif /* IO_TIKHUB_CLIENT_API_DouyinAppV2APIApi_H_ */
