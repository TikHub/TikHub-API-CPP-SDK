...
#ifndef IO_TIKHUB_CLIENT_API_Lemon8AppAPIApi_H_
#define IO_TIKHUB_CLIENT_API_Lemon8AppAPIApi_H_
...
public:
    ...
    explicit Lemon8AppAPIApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~Lemon8AppAPIApi();
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDiscoverBannersApiV1Lemon8AppFetchDiscoverBannersGet(
    ) const;
    /// <summary>
    /// 获取发现页Banner/Get banners of discover page
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取发现页Banner（搜索页上方的滚动内容） ### 返回: - Banner列表  # [English] ### Purpose: - Get banners of discover page ### Return: - Banners list  # [示例/Example]
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDiscoverBannersApiV1Lemon8AppFetchDiscoverBannersGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDiscoverTabApiV1Lemon8AppFetchDiscoverTabGet(
    ) const;
    /// <summary>
    /// 获取发现页主体内容/Get main content of discover page
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取发现页（搜索页主体内容） ### 返回: - 主体内容  # [English] ### Purpose: - Get main content of discover page ### Return: - Main content  # [示例/Example]
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDiscoverTabApiV1Lemon8AppFetchDiscoverTabGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDiscoverTabInformationTabsApiV1Lemon8AppFetchDiscoverTabInformationTabsGet(
    ) const;
    /// <summary>
    /// 获取发现页的 Editor&#39;s Picks/Get Editor&#39;s Picks of discover page
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取发现页（搜索页下方的推荐内容 - Editor&#39;s Picks） ### 返回: - 推荐内容  # [English] ### Purpose: - Get Editor&#39;s Picks of discover page ### Return: - Editor&#39;s Picks  # [示例/Example]
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDiscoverTabInformationTabsApiV1Lemon8AppFetchDiscoverTabInformationTabsGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchKeywordsApiV1Lemon8AppFetchHotSearchKeywordsGet(
    ) const;
    /// <summary>
    /// 获取热搜关键词/Get hot search keywords
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取热搜关键词 ### 返回: - 热搜关键词列表  # [English] ### Purpose: - Get hot search keywords ### Return: - Hot search keywords list  # [示例/Example]
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchKeywordsApiV1Lemon8AppFetchHotSearchKeywordsGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="groupId">作品的group_id/Post&#39;s group_id</param>
    /// <param name="itemId">作品的item_id/Post&#39;s item_id</param>
    /// <param name="mediaId">作品的media_id/Post&#39;s media_id</param>
    /// <param name="offset">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchPostCommentListApiV1Lemon8AppFetchPostCommentListGet(
    ...
    /// <param name="mediaId">作品的media_id/Post&#39;s media_id</param>
    /// <param name="offset">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchPostCommentListApiV1Lemon8AppFetchPostCommentListGet_0(
        utility::string_t groupId,
        utility::string_t itemId,
        utility::string_t mediaId,
        boost::optional<utility::string_t> offset
    ...
    /// </remarks>
    /// <param name="itemId">作品ID/Post ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchPostDetailApiV1Lemon8AppFetchPostDetailGet(
        utility::string_t itemId
    ) const;
    /// <summary>
    /// 获取指定作品的信息/Get information of specified post
    ...
    /// </remarks>
    /// <param name="itemId">作品ID/Post ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchPostDetailApiV1Lemon8AppFetchPostDetailGet_0(
        utility::string_t itemId
    ) const;
    /// <summary>
    /// 搜索接口/Search API
    ...
    /// </remarks>
    /// <param name="query">搜索关键词/Search keyword</param>
    /// <param name="maxCursor">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="filterType">搜索过滤类型/Search filter type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="orderBy">搜索排序方式/Search sort type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="searchTab">搜索类型/Search type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchSearchApiV1Lemon8AppFetchSearchGet(
        ...
        boost::optional<utility::string_t> searchTab
    ) const;
    /// <summary>
    /// 搜索接口/Search API
    /// </summary>
    ...
    /// <param name="orderBy">搜索排序方式/Search sort type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="searchTab">搜索类型/Search type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchSearchApiV1Lemon8AppFetchSearchGet_0(
        utility::string_t query,
        boost::optional<utility::string_t> maxCursor,
        boost::optional<utility::string_t> filterType,
        boost::optional<utility::string_t> orderBy,
    ...
    /// </remarks>
    /// <param name="forumId">话题ID/Topic ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchTopicInfoApiV1Lemon8AppFetchTopicInfoGet(
    ...
    /// </remarks>
    /// <param name="forumId">话题ID/Topic ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchTopicInfoApiV1Lemon8AppFetchTopicInfoGet_0(
        utility::string_t forumId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="category">话题分类 ID/Topic category ID</param>
    /// <param name="categoryParameter">分类参数/Category parameter</param>
    /// <param name="hashtagName">Hashtag名称/Hashtag name</param>
    /// <param name="maxBehotTime">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="sortType">排序方式/Sort type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchTopicPostListApiV1Lemon8AppFetchTopicPostListGet(
        utility::string_t category,
        utility::string_t categoryParameter,
        utility::string_t hashtagName,
    ...
    /// <param name="maxBehotTime">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="sortType">排序方式/Sort type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchTopicPostListApiV1Lemon8AppFetchTopicPostListGet_0(
        utility::string_t category,
        utility::string_t categoryParameter,
        utility::string_t hashtagName,
        boost::optional<utility::string_t> maxBehotTime,
    ...
    /// <param name="cursor">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFollowerListApiV1Lemon8AppFetchUserFollowerListGet(
    ...
    /// <param name="userId">用户ID/User ID</param>
    /// <param name="cursor">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFollowerListApiV1Lemon8AppFetchUserFollowerListGet_0(
        utility::string_t userId,
        boost::optional<utility::string_t> cursor
    ) const;
    /// <summary>
    ...
    /// <param name="userId">用户ID/User ID</param>
    /// <param name="cursor">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFollowingListApiV1Lemon8AppFetchUserFollowingListGet(
        utility::string_t userId,
        boost::optional<utility::string_t> cursor
    ) const;
    /// <summary>
    ...
    /// <param name="userId">用户ID/User ID</param>
    /// <param name="cursor">翻页参数/Pagination parameter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFollowingListApiV1Lemon8AppFetchUserFollowingListGet_0(
        utility::string_t userId,
        boost::optional<utility::string_t> cursor
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> getItemIdApiV1Lemon8AppGetItemIdGet(
    ...
    /// </remarks>
    /// <param name="shareText">分享链接/Share link</param>
    pplx::task<std::shared_ptr<ResponseModel>> getItemIdApiV1Lemon8AppGetItemIdGet_0(
        utility::string_t shareText
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> getItemIdsApiV1Lemon8AppGetItemIdsPost(
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getItemIdsApiV1Lemon8AppGetItemIdsPost_0(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="shareText">分享链接/Share link</param>
    pplx::task<std::shared_ptr<ResponseModel>> getUserIdApiV1Lemon8AppGetUserIdGet(
        utility::string_t shareText
    ) const;
    /// <summary>
    /// 通过分享链接获取用户ID/Get user ID through sharing link
    ...
    /// </remarks>
    /// <param name="shareText">分享链接/Share link</param>
    pplx::task<std::shared_ptr<ResponseModel>> getUserIdApiV1Lemon8AppGetUserIdGet_0(
        utility::string_t shareText
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getUserIdsApiV1Lemon8AppGetUserIdsPost(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    /// 通过分享链接批量获取用户ID/Get user IDs in batch through sharing links
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getUserIdsApiV1Lemon8AppGetUserIdsPost_0(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="userId">用户ID/User ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileApiV1Lemon8AppFetchUserProfileGet(
        utility::string_t userId
    ) const;
    /// <summary>
    /// 获取指定用户的信息/Get information of specified user
    ...
    /// </remarks>
    /// <param name="userId">用户ID/User ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileApiV1Lemon8AppFetchUserProfileGet_0(
        utility::string_t userId
    ) const;
...
#endif /* IO_TIKHUB_CLIENT_API_Lemon8AppAPIApi_H_ */
