...
#ifndef IO_TIKHUB_CLIENT_API_DouyinWebAPIApi_H_
#define IO_TIKHUB_CLIENT_API_DouyinWebAPIApi_H_
...
public:
    ...
    explicit DouyinWebAPIApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~DouyinWebAPIApi();
    ...
    pplx::task<std::shared_ptr<ResponseModel>> douyinLiveRoomApiV1DouyinWebDouyinLiveRoomGet(
    ...
    /// <param name="liveRoomUrl">直播间链接/Live room link</param>
    /// <param name="danmakuType">消息类型/Message type</param>
    pplx::task<std::shared_ptr<ResponseModel>> douyinLiveRoomApiV1DouyinWebDouyinLiveRoomGet_0(
        utility::string_t liveRoomUrl,
        utility::string_t danmakuType
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="billboardType">热点类型/Hotspot type</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchBillboardCategoriesApiV1DouyinWebFetchBillboardCategoriesGet(
    ...
    /// </remarks>
    /// <param name="billboardType">热点类型/Hotspot type</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchBillboardCategoriesApiV1DouyinWebFetchBillboardCategoriesGet_0(
        utility::string_t billboardType
    ) const;
    /// <summary>
    ...
    /// <param name="sentenceId">分类ID/Category ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchBillboardRelatedVideosApiV1DouyinWebFetchBillboardRelatedVideosGet(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceId
    ) const;
    /// <summary>
    /// 抖音榜单相关视频/Douyin Billboard Related Videos
    /// </summary>
    ...
    /// <param name="pageSize">每页数量/Number per page</param>
    /// <param name="sentenceId">分类ID/Category ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchBillboardRelatedVideosApiV1DouyinWebFetchBillboardRelatedVideosGet_0(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceId
    ) const;
    ...
    /// </remarks>
    /// <param name="count">每页数量/Number per page</param>
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCartoonAwemeApiV1DouyinWebFetchCartoonAwemeGet(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCartoonAwemeApiV1DouyinWebFetchCartoonAwemeGet_0(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCartoonAwemeApiV1DouyinWebFetchFoodAwemeGet(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCartoonAwemeApiV1DouyinWebFetchFoodAwemeGet_0(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCartoonAwemeApiV1DouyinWebFetchMusicAwemeGet(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCartoonAwemeApiV1DouyinWebFetchMusicAwemeGet_0(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// </remarks>
    /// <param name="challengePostRequest"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchChallengePostsApiV1DouyinWebFetchChallengePostsPost(
        boost::optional<std::shared_ptr<ChallengePostRequest>> challengePostRequest
    ) const;
    /// <summary>
    /// 话题作品/Challenge Posts
    /// </summary>
    ...
    /// </remarks>
    /// <param name="challengePostRequest"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchChallengePostsApiV1DouyinWebFetchChallengePostsPost_0(
        boost::optional<std::shared_ptr<ChallengePostRequest>> challengePostRequest
    ) const;
    /// <summary>
    ...
    /// <param name="page">页码/Page number</param>
    /// <param name="pageSize">每页数量/Number per page</param>
    /// <param name="sentenceTag">分类标签/Category tag</param>
    /// <param name="order">排序方式/Sorting method</param>
    /// <param name="cityCode">城市代码/City code</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCityHotListApiV1DouyinWebFetchCityHotListGet(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceTag,
        utility::string_t order,
        utility::string_t cityCode
    ) const;
    /// <summary>
    /// 抖音同城热点榜单/Douyin City Hot List
    /// </summary>
    ...
    /// <param name="order">排序方式/Sorting method</param>
    /// <param name="cityCode">城市代码/City code</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCityHotListApiV1DouyinWebFetchCityHotListGet_0(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceTag,
        utility::string_t order,
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCityListApiV1DouyinWebFetchCityListGet(
    ) const;
    /// <summary>
    /// 抖音城市列表/Douyin City List
    /// </summary>
    ...
    /// # [中文] ### 用途: - 抖音城市列表以及城市ID ### 返回: - 城市列表数据  # [English] ### Purpose: - Douyin City List and City ID ### Return: - City list data
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchCityListApiV1DouyinWebFetchCityListGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="userAgent">用户浏览器代理/User browser agent</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDouyinWebGuestCookieApiV1DouyinWebFetchDouyinWebGuestCookieGet(
    ...
    /// </remarks>
    /// <param name="userAgent">用户浏览器代理/User browser agent</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchDouyinWebGuestCookieApiV1DouyinWebFetchDouyinWebGuestCookieGet_0(
        utility::string_t userAgent
    ) const;
    /// <summary>
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchGameAwemeApiV1DouyinWebFetchGameAwemeGet(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchGameAwemeApiV1DouyinWebFetchGameAwemeGet_0(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// <param name="searchRange">搜索范围/Search range (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchGeneralSearchResultApiV1DouyinWebFetchGeneralSearchResultGet(
        ...
        boost::optional<utility::string_t> searchRange,
    ...
    /// <param name="contentType">内容类型/Content type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchGeneralSearchResultApiV1DouyinWebFetchGeneralSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> sortType,
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHomeFeedApiV1DouyinWebFetchHomeFeedGet(
        boost::optional<int32_t> count,
        boost::optional<int32_t> refreshIndex
    ) const;
    /// <summary>
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHomeFeedApiV1DouyinWebFetchHomeFeedGet_0(
        boost::optional<int32_t> count,
        boost::optional<int32_t> refreshIndex
    ) const;
    /// <summary>
    ...
    /// <param name="pageSize">每页数量/Number per page</param>
    /// <param name="sentenceTag">分类标签/Category tag</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotListApiV1DouyinWebFetchHotListGet(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceTag
    ) const;
    ...
    /// <param name="pageSize">每页数量/Number per page</param>
    /// <param name="sentenceTag">分类标签/Category tag</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotListApiV1DouyinWebFetchHotListGet_0(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceTag
    ) const;
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchResultApiV1DouyinWebFetchHotSearchResultGet(
    ) const;
    /// <summary>
    /// 获取抖音热榜数据/Get Douyin hot search results
    /// </summary>
    ...
    /// # [中文] ### 用途: - 获取抖音热榜数据 ### 返回: - 热榜数据  # [English] ### Purpose: - Get Douyin hot search results ### Return: - Hot search results
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> fetchHotSearchResultApiV1DouyinWebFetchHotSearchResultGet_0(
    ) const;
    /// <summary>
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchKnowledgeAwemeApiV1DouyinWebFetchKnowledgeAwemeGet(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchKnowledgeAwemeApiV1DouyinWebFetchKnowledgeAwemeGet_0(
        int32_t count,
        boost::optional<int32_t> refreshIndex,
        boost::optional<utility::string_t> cookie
    ) const;
    ...
    /// </remarks>
    /// <param name="roomId">直播间room_id/Room room_id</param>
    /// <param name="rankType">排行类型/Leaderboard type (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveGiftRankingApiV1DouyinWebFetchLiveGiftRankingGet(
    ...
    /// <param name="roomId">直播间room_id/Room room_id</param>
    /// <param name="rankType">排行类型/Leaderboard type (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveGiftRankingApiV1DouyinWebFetchLiveGiftRankingGet_0(
        utility::string_t roomId,
        boost::optional<int32_t> rankType
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="roomId">直播间room_id/Room room_id</param>
    /// <param name="authorId">作者id/Author id</param>
    /// <param name="limit">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveRoomProductResultApiV1DouyinWebFetchLiveRoomProductResultGet(
        utility::string_t roomId,
    ...
    /// <param name="authorId">作者id/Author id</param>
    /// <param name="limit">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveRoomProductResultApiV1DouyinWebFetchLiveRoomProductResultGet_0(
        utility::string_t roomId,
        utility::string_t authorId,
        boost::optional<int32_t> limit
    ) const;
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveSearchResultApiV1DouyinWebFetchLiveSearchResultGet(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> searchId
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchLiveSearchResultApiV1DouyinWebFetchLiveSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> searchId
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchMultiVideoApiV1DouyinWebFetchMultiVideoPost(
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchMultiVideoApiV1DouyinWebFetchMultiVideoPost_0(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoApiV1DouyinWebFetchOneVideoGet(
    ...
    /// </remarks>
    /// <param name="awemeId">作品id/Video id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoApiV1DouyinWebFetchOneVideoGet_0(
        utility::string_t awemeId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="awemeId">作品id/Video id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoApiV1DouyinWebFetchOneVideoV2Get(
        utility::string_t awemeId
    ) const;
    /// <summary>
    /// 获取单个作品数据 V2/Get single video data V2
    ...
    /// </remarks>
    /// <param name="awemeId">作品id/Video id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoApiV1DouyinWebFetchOneVideoV2Get_0(
        utility::string_t awemeId
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoByShareUrlApiV1DouyinWebFetchOneVideoByShareUrlGet(
    ...
    /// </remarks>
    /// <param name="shareUrl">分享链接/Share link</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoByShareUrlApiV1DouyinWebFetchOneVideoByShareUrlGet_0(
        utility::string_t shareUrl
    ) const;
    /// <summary>
    ...
    /// <param name="duration">视频总时长/Video total duration</param>
    /// <param name="endTime">结束时间/End time</param>
    /// <param name="startTime">开始时间/Start time</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoDanmakuApiV1DouyinWebFetchOneVideoDanmakuGet(
    ...
    /// <param name="endTime">结束时间/End time</param>
    /// <param name="startTime">开始时间/Start time</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchOneVideoDanmakuApiV1DouyinWebFetchOneVideoDanmakuGet_0(
        utility::string_t itemId,
        int32_t duration,
        int32_t endTime,
        int32_t startTime
    ...
    /// <param name="page">页码/Page number</param>
    /// <param name="pageSize">每页数量/Number per page</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchRealTimeChallengeListApiV1DouyinWebFetchRealTimeChallengeListGet(
        int32_t page,
        int32_t pageSize
    ) const;
    /// <summary>
    ...
    /// <param name="page">页码/Page number</param>
    /// <param name="pageSize">每页数量/Number per page</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchRealTimeChallengeListApiV1DouyinWebFetchRealTimeChallengeListGet_0(
        int32_t page,
        int32_t pageSize
    ) const;
    /// <summary>
    ...
    /// <param name="sentenceTag">分类标签/Category tag</param>
    /// <param name="order">排序方式/Sorting method</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchRealTimeRisingHotListApiV1DouyinWebFetchRealTimeRisingHotListGet(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceTag,
        utility::string_t order
    ...
    /// <param name="sentenceTag">分类标签/Category tag</param>
    /// <param name="order">排序方式/Sorting method</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchRealTimeRisingHotListApiV1DouyinWebFetchRealTimeRisingHotListGet_0(
        int32_t page,
        int32_t pageSize,
        utility::string_t sentenceTag,
        utility::string_t order
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchRelatedPostsApiV1DouyinWebFetchRelatedPostsGet(
        utility::string_t awemeId,
        boost::optional<int32_t> refreshIndex,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="refreshIndex">翻页索引/Paging index (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchRelatedPostsApiV1DouyinWebFetchRelatedPostsGet_0(
        utility::string_t awemeId,
        boost::optional<int32_t> refreshIndex,
        boost::optional<int32_t> count
    ) const;
    ...
    /// </remarks>
    /// <param name="searchChallengeRequest"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchSearchChallengeApiV1DouyinWebFetchSearchChallengePost(
        boost::optional<std::shared_ptr<SearchChallengeRequest>> searchChallengeRequest
    ) const;
    /// <summary>
    /// 搜索话题/Search Challenge
    /// </summary>
    ...
    /// </remarks>
    /// <param name="searchChallengeRequest"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchSearchChallengeApiV1DouyinWebFetchSearchChallengePost_0(
        boost::optional<std::shared_ptr<SearchChallengeRequest>> searchChallengeRequest
    ) const;
    /// <summary>
    /// 短剧作品/Series Video
    ...
    /// </remarks>
    /// <param name="offset">页码/Page number</param>
    /// <param name="count">每页数量/Number per page</param>
    /// <param name="contentType">短剧类型/Subtype</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchSeriesAwemeApiV1DouyinWebFetchSeriesAwemeGet(
        int32_t offset,
        int32_t count,
        int32_t contentType,
        boost::optional<utility::string_t> cookie
    ...
    /// <param name="contentType">短剧类型/Subtype</param>
    /// <param name="cookie">用户自行提供的Cookie/User provided Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchSeriesAwemeApiV1DouyinWebFetchSeriesAwemeGet_0(
        int32_t offset,
        int32_t count,
        int32_t contentType,
        boost::optional<utility::string_t> cookie
    ...
    /// </remarks>
    /// <param name="cookie">用户网页版抖音Cookie/Your web version of Douyin Cookie</param>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserCollectionVideosApiV1DouyinWebFetchUserCollectionVideosGet(
    ...
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserCollectionVideosApiV1DouyinWebFetchUserCollectionVideosGet_0(
        utility::string_t cookie,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> counts
    ) const;
    ...
    /// </remarks>
    /// <param name="collectsId">收藏夹id/Collection id</param>
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserCollectsVideosApiV1DouyinWebFetchUserCollectsVideosGet(
        utility::string_t collectsId,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> counts
    ) const;
    /// <summary>
    ...
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserCollectsVideosApiV1DouyinWebFetchUserCollectsVideosGet_0(
        utility::string_t collectsId,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> counts
    ) const;
    ...
    /// </remarks>
    /// <param name="secUid">用户sec_uid/Sec_uid of user</param>
    /// <param name="interestType">兴趣类型/Interest type</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFansInterestApiV1DouyinWebFetchUserFansInterestGet(
        utility::string_t secUid,
        utility::string_t interestType
    ) const;
    /// <summary>
    /// 抖音用户粉丝兴趣/Douyin User Fans Interest
    /// </summary>
    ...
    /// <param name="secUid">用户sec_uid/Sec_uid of user</param>
    /// <param name="interestType">兴趣类型/Interest type</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFansInterestApiV1DouyinWebFetchUserFansInterestGet_0(
        utility::string_t secUid,
        utility::string_t interestType
    ) const;
    /// <summary>
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="sourceType">来源类型/Source type (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFansListApiV1DouyinWebFetchUserFansListGet(
        boost::optional<utility::string_t> secUserId,
        boost::optional<utility::string_t> maxTime,
        boost::optional<int32_t> count,
        boost::optional<int32_t> sourceType
    ) const;
    /// <summary>
    /// 获取用户粉丝列表/Get user fans list
    /// </summary>
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="sourceType">来源类型/Source type (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFansListApiV1DouyinWebFetchUserFansListGet_0(
        boost::optional<utility::string_t> secUserId,
        boost::optional<utility::string_t> maxTime,
        boost::optional<int32_t> count,
        boost::optional<int32_t> sourceType
    ...
    /// </remarks>
    /// <param name="secUid">用户sec_uid/Sec_uid of user</param>
    /// <param name="option">选项/Option (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFansPortraitApiV1DouyinWebFetchUserFansPortraitGet(
        utility::string_t secUid,
        boost::optional<utility::string_t> option
    ) const;
    /// <summary>
    /// 抖音用户粉丝画像/Douyin User Fans Portrait
    /// </summary>
    ...
    /// <param name="secUid">用户sec_uid/Sec_uid of user</param>
    /// <param name="option">选项/Option (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFansPortraitApiV1DouyinWebFetchUserFansPortraitGet_0(
        utility::string_t secUid,
        boost::optional<utility::string_t> option
    ) const;
    /// <summary>
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="sourceType">来源类型/Source type (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFollowingListApiV1DouyinWebFetchUserFollowingListGet(
        boost::optional<utility::string_t> secUserId,
        boost::optional<utility::string_t> maxTime,
        boost::optional<int32_t> count,
        boost::optional<int32_t> sourceType
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="sourceType">来源类型/Source type (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserFollowingListApiV1DouyinWebFetchUserFollowingListGet_0(
        boost::optional<utility::string_t> secUserId,
        boost::optional<utility::string_t> maxTime,
        boost::optional<int32_t> count,
        boost::optional<int32_t> sourceType
    ...
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    /// <param name="cookie">用户网页版抖音Cookie/Your web version of Douyin Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLikeVideosApiV1DouyinWebFetchUserLikeVideosGet(
    ...
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    /// <param name="cookie">用户网页版抖音Cookie/Your web version of Douyin Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLikeVideosApiV1DouyinWebFetchUserLikeVideosGet_0(
        utility::string_t secUserId,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> counts,
        boost::optional<utility::string_t> cookie
    ...
    /// </remarks>
    /// <param name="uid">用户UID/User UID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveInfoByUidApiV1DouyinWebFetchUserLiveInfoByUidGet(
    ...
    /// </remarks>
    /// <param name="uid">用户UID/User UID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveInfoByUidApiV1DouyinWebFetchUserLiveInfoByUidGet_0(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="webcastId">直播间webcast_id/Room webcast_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosApiV1DouyinWebFetchUserLiveVideosGet(
        utility::string_t webcastId
    ) const;
    /// <summary>
    /// 获取用户直播流数据/Get user live video data
    /// </summary>
    ...
    /// </remarks>
    /// <param name="webcastId">直播间webcast_id/Room webcast_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosApiV1DouyinWebFetchUserLiveVideosGet_0(
        utility::string_t webcastId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="roomId">直播间room_id/Room room_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosByRoomIdApiV1DouyinWebFetchUserLiveVideosByRoomIdGet(
        utility::string_t roomId
    ) const;
    /// <summary>
    /// 获取指定用户的直播流数据/Get live video data of specified user
    ...
    /// </remarks>
    /// <param name="roomId">直播间room_id/Room room_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosByRoomIdApiV1DouyinWebFetchUserLiveVideosByRoomIdGet_0(
        utility::string_t roomId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="roomId">直播间room_id/Room room_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosByRoomIdV2ApiV1DouyinWebFetchUserLiveVideosByRoomIdV2Get(
        utility::string_t roomId
    ) const;
    /// <summary>
    /// 获取指定用户的直播流数据V2/Gets the live stream data of the specified user V2
    ...
    /// </remarks>
    /// <param name="roomId">直播间room_id/Room room_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosByRoomIdV2ApiV1DouyinWebFetchUserLiveVideosByRoomIdV2Get_0(
        utility::string_t roomId
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosBySecUidApiV1DouyinWebFetchUserLiveVideosBySecUidGet(
        utility::string_t secUid
    ) const;
    /// <summary>
    /// 通过sec_uid获取指定用户的直播流数据/Get live video data of specified user by sec_uid
    ...
    /// </remarks>
    /// <param name="secUid">用户sec_uid/User sec_uid</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserLiveVideosBySecUidApiV1DouyinWebFetchUserLiveVideosBySecUidGet_0(
        utility::string_t secUid
    ) const;
    /// <summary>
    ...
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserMixVideosApiV1DouyinWebFetchUserMixVideosGet(
    ...
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to 0)</param>
    /// <param name="counts">每页数量/Number per page (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserMixVideosApiV1DouyinWebFetchUserMixVideosGet_0(
        utility::string_t mixId,
        boost::optional<int32_t> maxCursor,
        boost::optional<int32_t> counts
    ) const;
    ...
    /// </remarks>
    /// <param name="secUserId">用户sec_user_id/User sec_user_id</param>
    /// <param name="maxCursor">最大游标/Maximum cursor (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="count">每页数量/Number per page (optional, default to 0)</param>
    /// <param name="filterType">过滤类型/Filter type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="cookie">用户网页版抖音Cookie/Your web version of Douyin Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserPostVideosApiV1DouyinWebFetchUserPostVideosGet(
        utility::string_t secUserId,
        boost::optional<utility::string_t> maxCursor,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> filterType,
        boost::optional<utility::string_t> cookie
    ) const;
    /// <summary>
    /// 获取用户主页作品数据/Get user homepage video data
    ...
    /// <param name="filterType">过滤类型/Filter type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="cookie">用户网页版抖音Cookie/Your web version of Douyin Cookie (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserPostVideosApiV1DouyinWebFetchUserPostVideosGet_0(
        utility::string_t secUserId,
        boost::optional<utility::string_t> maxCursor,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> filterType,
    ...
    /// </remarks>
    /// <param name="shortId">用户Short ID/User Short ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserProfileByShortIdApiV1DouyinWebFetchUserProfileByShortIdGet(
        utility::string_t shortId
    ) const;
    /// <summary>
    /// 使用Short ID获取用户信息/Get user information by Short ID
    /// </summary>
    ...
    /// </remarks>
    /// <param name="shortId">用户Short ID/User Short ID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserProfileByShortIdApiV1DouyinWebFetchUserProfileByShortIdGet_0(
        utility::string_t shortId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid">用户UID/User UID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserProfileByUidApiV1DouyinWebFetchUserProfileByUidGet(
        utility::string_t uid
    ) const;
    /// <summary>
    /// 使用UID获取用户信息/Get user information by UID
    ...
    /// </remarks>
    /// <param name="uid">用户UID/User UID</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserProfileByUidApiV1DouyinWebFetchUserProfileByUidGet_0(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultApiV1DouyinWebFetchUserSearchResultGet(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
    ...
    /// <param name="douyinUserType">用户类型/User type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultApiV1DouyinWebFetchUserSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> douyinUserFans,
    ...
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultV2ApiV1DouyinWebFetchUserSearchResultV2Get(
        utility::string_t keyword,
    ...
    /// <param name="keyword">关键词/Keyword</param>
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultV2ApiV1DouyinWebFetchUserSearchResultV2Get_0(
        utility::string_t keyword,
        boost::optional<int32_t> cursor
    ) const;
    /// <summary>
    ...
    /// <param name="douyinUserType">用户类型/User type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="douyinUserFans">粉丝数/Fans (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultV3ApiV1DouyinWebFetchUserSearchResultV3Get(
        utility::string_t keyword,
    ...
    /// <param name="douyinUserType">用户类型/User type (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="douyinUserFans">粉丝数/Fans (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchUserSearchResultV3ApiV1DouyinWebFetchUserSearchResultV3Get_0(
        utility::string_t keyword,
        boost::optional<utility::string_t> cursor,
        boost::optional<utility::string_t> douyinUserType,
        boost::optional<utility::string_t> douyinUserFans
    ...
    /// <param name="page">页码/Page number</param>
    /// <param name="pageSize">每页数量/Number per page</param>
    /// <param name="subType">子类型/Subtype</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoBillboardApiV1DouyinWebFetchVideoBillboardGet(
        int32_t date,
        int32_t page,
        int32_t pageSize,
        int32_t subType
    ...
    /// <param name="pageSize">每页数量/Number per page</param>
    /// <param name="subType">子类型/Subtype</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoBillboardApiV1DouyinWebFetchVideoBillboardGet_0(
        int32_t date,
        int32_t page,
        int32_t pageSize,
        int32_t subType
    ...
    /// </remarks>
    /// <param name="tagId">标签id/Tag id</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="refreshIndex">刷新索引/Refresh index (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoChannelResultApiV1DouyinWebFetchVideoChannelResultGet(
        int32_t tagId,
        boost::optional<int32_t> count,
        boost::optional<int32_t> refreshIndex
    ) const;
    ...
    /// <param name="count">数量/Number (optional, default to 0)</param>
    /// <param name="refreshIndex">刷新索引/Refresh index (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoChannelResultApiV1DouyinWebFetchVideoChannelResultGet_0(
        int32_t tagId,
        boost::optional<int32_t> count,
        boost::optional<int32_t> refreshIndex
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsApiV1DouyinWebFetchVideoCommentsGet(
        utility::string_t awemeId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsApiV1DouyinWebFetchVideoCommentsGet_0(
        utility::string_t awemeId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ) const;
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsReplyApiV1DouyinWebFetchVideoCommentRepliesGet(
        utility::string_t itemId,
    ...
    /// <param name="cursor">游标/Cursor (optional, default to 0)</param>
    /// <param name="count">数量/Number (optional, default to 0)</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoCommentsReplyApiV1DouyinWebFetchVideoCommentRepliesGet_0(
        utility::string_t itemId,
        utility::string_t commentId,
        boost::optional<int32_t> cursor,
        boost::optional<int32_t> count
    ...
    /// </remarks>
    /// <param name="awemeId">作品id/Video id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoFansAddCountApiV1DouyinWebFetchVideoFansAddCountGet(
        utility::string_t awemeId
    ) const;
    /// <summary>
    /// 获取视频新增粉丝数量/Get video new fans count
    ...
    /// </remarks>
    /// <param name="awemeId">作品id/Video id</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoFansAddCountApiV1DouyinWebFetchVideoFansAddCountGet_0(
        utility::string_t awemeId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="awemeId">视频aweme_id/Aweme_id of video</param>
    /// <param name="option">选项/Option</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoLikePortraitApiV1DouyinWebFetchVideoLikePortraitGet(
        utility::string_t awemeId,
    ...
    /// <param name="awemeId">视频aweme_id/Aweme_id of video</param>
    /// <param name="option">选项/Option</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoLikePortraitApiV1DouyinWebFetchVideoLikePortraitGet_0(
        utility::string_t awemeId,
        utility::string_t option
    ) const;
    /// <summary>
    ...
    /// <param name="filterDuration">视频时长/Duration filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoSearchResultApiV1DouyinWebFetchVideoSearchResultGet(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> sortType,
    ...
    /// <param name="filterDuration">视频时长/Duration filter (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoSearchResultApiV1DouyinWebFetchVideoSearchResultGet_0(
        utility::string_t keyword,
        boost::optional<int32_t> offset,
        boost::optional<int32_t> count,
        boost::optional<utility::string_t> sortType,
    ...
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoSearchResultV2ApiV1DouyinWebFetchVideoSearchResultV2Get(
        utility::string_t keyword,
        boost::optional<utility::string_t> sortType,
        boost::optional<utility::string_t> publishTime,
        boost::optional<utility::string_t> filterDuration,
    ...
    /// <param name="page">页码/Page (optional, default to 0)</param>
    /// <param name="searchId">搜索id，翻页时需要提供/Search id, need to provide when paging (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> fetchVideoSearchResultV2ApiV1DouyinWebFetchVideoSearchResultV2Get_0(
        utility::string_t keyword,
        boost::optional<utility::string_t> sortType,
        boost::optional<utility::string_t> publishTime,
        boost::optional<utility::string_t> filterDuration,
    ...
    /// </remarks>
    /// <param name="aBogusModel"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> generateABogusApiV1DouyinWebGenerateABogusPost(
        boost::optional<std::shared_ptr<ABogusModel>> aBogusModel
    ) const;
    /// <summary>
    /// 使用接口网址生成A-Bogus参数/Generate A-Bogus parameter using API URL
    /// </summary>
    ...
    /// </remarks>
    /// <param name="aBogusModel"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> generateABogusApiV1DouyinWebGenerateABogusPost_0(
        boost::optional<std::shared_ptr<ABogusModel>> aBogusModel
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> generateRealMsTokenApiV1DouyinWebGenerateRealMsTokenGet(
    ) const;
    /// <summary>
    /// 生成真实msToken/Generate real msToken
    /// </summary>
    ...
    /// # [中文] ### 用途: - 生成真实msToken ### 返回: - msToken  # [English] ### Purpose: - Generate real msToken ### Return: - msToken
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> generateRealMsTokenApiV1DouyinWebGenerateRealMsTokenGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> generateSVWebIdApiV1DouyinWebGenerateSVWebIdGet(
    ) const;
    /// <summary>
    /// 生成s_v_web_id/Generate s_v_web_id
    /// </summary>
    ...
    /// # [中文] ### 用途: - 生成s_v_web_id ### 返回: - s_v_web_id  # [English] ### Purpose: - Generate s_v_web_id ### Return: - s_v_web_id
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> generateSVWebIdApiV1DouyinWebGenerateSVWebIdGet_0(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="userAgent"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> generateTtwidApiV1DouyinWebGenerateTtwidGet(
    ...
    /// </remarks>
    /// <param name="userAgent"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<ResponseModel>> generateTtwidApiV1DouyinWebGenerateTtwidGet_0(
        boost::optional<utility::string_t> userAgent
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> generateVerifyFpApiV1DouyinWebGenerateVerifyFpGet(
    ) const;
    /// <summary>
    /// 生成verify_fp/Generate verify_fp
    /// </summary>
    ...
    /// # [中文] ### 用途: - 生成verify_fp ### 返回: - verify_fp  # [English] ### Purpose: - Generate verify_fp ### Return: - verify_fp
    /// </remarks>
    pplx::task<std::shared_ptr<ResponseModel>> generateVerifyFpApiV1DouyinWebGenerateVerifyFpGet_0(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> generateXBogusApiV1DouyinWebGenerateXBogusPost(
    ...
    /// </remarks>
    /// <param name="xBogusModel"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> generateXBogusApiV1DouyinWebGenerateXBogusPost_0(
        boost::optional<std::shared_ptr<XBogusModel>> xBogusModel
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getAllAwemeIdApiV1DouyinWebGetAllAwemeIdPost(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    /// 提取列表作品id/Extract list video id
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getAllAwemeIdApiV1DouyinWebGetAllAwemeIdPost_0(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getAllSecUserIdApiV1DouyinWebGetAllSecUserIdPost(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    /// 提取列表用户id/Extract list user id
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getAllSecUserIdApiV1DouyinWebGetAllSecUserIdPost_0(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getAllWebcastIdApiV1DouyinWebGetAllWebcastIdPost(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    /// 提取列表直播间号/Extract list webcast id
    ...
    /// </remarks>
    /// <param name="utilityStringT"> (optional)</param>
    pplx::task<std::shared_ptr<ResponseModel>> getAllWebcastIdApiV1DouyinWebGetAllWebcastIdPost_0(
        boost::optional<std::vector<utility::string_t>> utilityStringT
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ResponseModel>> getAwemeIdApiV1DouyinWebGetAwemeIdGet(
    ...
    /// </remarks>
    /// <param name="url"></param>
    pplx::task<std::shared_ptr<ResponseModel>> getAwemeIdApiV1DouyinWebGetAwemeIdGet_0(
        utility::string_t url
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="url"></param>
    pplx::task<std::shared_ptr<ResponseModel>> getSecUserIdApiV1DouyinWebGetSecUserIdGet(
        utility::string_t url
    ) const;
    /// <summary>
    /// 提取单个用户id/Extract single user id
    ...
    /// </remarks>
    /// <param name="url"></param>
    pplx::task<std::shared_ptr<ResponseModel>> getSecUserIdApiV1DouyinWebGetSecUserIdGet_0(
        utility::string_t url
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="url"></param>
    pplx::task<std::shared_ptr<ResponseModel>> getWebcastIdApiV1DouyinWebGetWebcastIdGet(
        utility::string_t url
    ) const;
    /// <summary>
    /// 提取直播间号/Extract webcast id
    ...
    /// </remarks>
    /// <param name="url"></param>
    pplx::task<std::shared_ptr<ResponseModel>> getWebcastIdApiV1DouyinWebGetWebcastIdGet_0(
        utility::string_t url
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="secUserId">用户sec_user_id/User sec_user_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileApiV1DouyinWebHandlerUserProfileGet(
        utility::string_t secUserId
    ) const;
    /// <summary>
    /// 根据sec_user_id获取指定用户的信息/Get information of specified user by sec_user_id
    ...
    /// </remarks>
    /// <param name="secUserId">用户sec_user_id/User sec_user_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileApiV1DouyinWebHandlerUserProfileGet_0(
        utility::string_t secUserId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uniqueId">用户unique_id/User unique_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileV2ApiV1DouyinWebHandlerUserProfileV2Get(
    ...
    /// </remarks>
    /// <param name="uniqueId">用户unique_id/User unique_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileV2ApiV1DouyinWebHandlerUserProfileV2Get_0(
        utility::string_t uniqueId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="uid">用户uid(short_id)/User uid(short_id)</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileV3ApiV1DouyinWebHandlerUserProfileV3Get(
        utility::string_t uid
    ) const;
    /// <summary>
    /// 根据抖音uid获取指定用户的信息/Get information of specified user by uid
    ...
    /// </remarks>
    /// <param name="uid">用户uid(short_id)/User uid(short_id)</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileV3ApiV1DouyinWebHandlerUserProfileV3Get_0(
        utility::string_t uid
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="secUserId">用户sec_user_id/User sec_user_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileV4ApiV1DouyinWebHandlerUserProfileV4Get(
        utility::string_t secUserId
    ) const;
    /// <summary>
    /// 根据sec_user_id获取指定用户的信息（性别，年龄，直播等级、牌子）/Get information of specified user by sec_user_id (gender, age, live level、brand)
    ...
    /// </remarks>
    /// <param name="secUserId">用户sec_user_id/User sec_user_id</param>
    pplx::task<std::shared_ptr<ResponseModel>> handlerUserProfileV4ApiV1DouyinWebHandlerUserProfileV4Get_0(
        utility::string_t secUserId
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="webcastId">直播间号/Webcast id</param>
    pplx::task<std::shared_ptr<ResponseModel>> webcastId2RoomIdApiV1DouyinWebWebcastId2RoomIdGet(
        utility::string_t webcastId
    ) const;
    /// <summary>
    /// 直播间号转房间号/Webcast id to room id
    ...
    /// </remarks>
    /// <param name="webcastId">直播间号/Webcast id</param>
    pplx::task<std::shared_ptr<ResponseModel>> webcastId2RoomIdApiV1DouyinWebWebcastId2RoomIdGet_0(
        utility::string_t webcastId
    ) const;
...
#endif /* IO_TIKHUB_CLIENT_API_DouyinWebAPIApi_H_ */
